...
euk_asv_filt_raw=read.table(file=paste0(output_tables,"FRAM_RAS_F4_EUK_ASV_filt_raw.txt"), sep="\t",
                            check.names=F, header=T, row.names=1)

euk_asv_filt_rare_raw=read.table(file=paste0(output_tables,"FRAM_RAS_F4_EUK_ASV_filt_rare_raw.txt"), sep="\t",
                            check.names=F, header=T, row.names=1) %>%
...
sample_meta=read.table(file="FRAM_RAS_F4_META.txt", sep="\t",
